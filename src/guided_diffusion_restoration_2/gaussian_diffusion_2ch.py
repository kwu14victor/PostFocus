...
def get_named_beta_schedule(schedule_name, num_diffusion_timesteps):
    ...
    if schedule_name == "linear":
        ...
        # diffusion steps.
        # 20230406 change here again
        # 20230411 change here to 1000 to see if model can still denoise
        #20230508 single variable
        scale = 1000 / num_diffusion_timesteps
        #20230414 try fixed beta
        beta_start =0.0001 
        #0.00003  #20230418
        #20230414
        #0.0001#scale * 0.0001
...
class GaussianDiffusion:
    ...
    def __init__(
        ...
        *,
        ...
        model_var_type,
        loss_type,
        rescale_timesteps=True, #20230412 changed here
    ):
    ...
    def _scale_timesteps(self, t):
        if self.rescale_timesteps:
            #20230406 change here again
            #20230411 change to 1000
            #20230508 single variable
            return t.float() * (Global_step/ self.num_timesteps)
            #(1000.0 / self.num_timesteps)
        return t
    ...
    def p_sample(
        ...
        """
        #print('size of x at function p_sample is:')
        #print(x.shape)
    ...
    def p_sample_loop_known(
        ...
        #print('input size at p_sample_loop_known function is:')
        #print(img.shape)
    ...
    def p_sample_loop_progressive(
        ...
        model,
        shape,
        #20230404 changed here to test if it speeds up
        #20230406 change here to 250 again
        #20230508 use a global variable
        time=Global_step, #1000,
        noise=None,
        clip_denoised=True,
        denoised_fn=None,
        cond_fn=None,
        ...
        if progress:
           ...
           for i in indices:
                ...
                with th.no_grad():
                    #print('img shape at p_sample_loop_progressive is:')
                    #print(img.shape)
                    
                    #if img.shape != (1, 2, 224, 224):#(1, 5, 224, 224): 20230324 chage here
    ...
    def ddim_sample_loop_progressive(
        ...
        #20230404 changed here to test if it speeds up
        #20230406 change here to 250 again
        #20230508 use a single variable
        time=Global_step,#1000,
        noise=None,
        clip_denoised=True,
        denoised_fn=None,
    ...
    def training_losses_segmentation(self, model, classifier, x_start, t, model_kwargs=None, noise=None):
        ...
        mask = x_start[:, -1:, ...]
        res = mask 
        #torch.where(mask > 0, 1, 0)   #merge all tumor classes into one to get a binary segmentation mask
        ...
        #x_t: multi-channel images
        #print('the shape of x_t is:')
        #print(x_t.shape)
        ...
        if self.loss_type == LossType.MSE or self.loss_type == LossType.RESCALED_MSE:
            ...
            if self.model_var_type in [
                ...
                model_output, model_var_values = th.split(model_output, C, dim=1)
                #print('output shape after split:')
                #print(model_output.shape)
                # cut the output in half (sized one and one and the original C is two!) from the second dimension 
                # Learn the variance using the variational bound, but don't let
                # it affect our mean prediction.
                frozen_out = th.cat([model_output.detach(), model_var_values], dim=1)
                #print('shape after frozen:')
                #print(frozen_out.shape)
                ...
                if self.loss_type == LossType.RESCALED_MSE:
                    ...
                    #20230406 change here to 250
                    #20230411 change to 1000 again
                    #20230508 use single variable
                    terms["vb"] *= self.num_timesteps / Global_step
